<?php
    ...
    require __DIR__ . '/assets/include/mailer/Exception.php';
    require __DIR__ . '/assets/include/mailer/PHPMailer.php';
    require __DIR__ . '/assets/include/mailer/SMTP.php';
?>

<?php require __DIR__ . '/sections/home-cover.php'; ?>
<?php require __DIR__ . '/sections/home-about.php'; ?>
<?php require __DIR__ . '/sections/home-team.php'; ?>
<?php require __DIR__ . '/sections/home-news.php'; ?>
<?php require __DIR__ . '/sections/home-tokenomics.php'; ?>
<?php require __DIR__ . '/sections/home-partners.php'; ?>
<?php require __DIR__ . '/sections/home-roadmap.php'; ?>
<?php require __DIR__ . '/sections/home-features.php'; ?>
	...
	<div class="container-fluid">
		<div class="row" style="padding-bottom:10px;">
			<div class="column col-12">
				<p class="text-center"><a href="/assets/downloads/REP-Charli3.io-2021-11-15.pdf" target="_blank">Official Certik and IOHK audit</a>.</p>
			</div>
		</div>
	</div> 
</section>
<!-- <section class="light-gray slim">
	<div class="container-fluid">
		<div class="row">
			<div class="column col-12">
				<p class="text-center"><a href="/assets/downloads/charli3-whitepaper.pdf" target="_blank">Old whitepaper</a>, new whitepaper in progress.</p>
			</div>
		</div>
	</div>
</section> -->